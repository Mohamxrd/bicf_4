...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
                ...
                <div class="flex-1 relative">
                    ...
                    <div class="max-w-[1220px] mx-auto flex items-center">
                        ...
                        <!-- search -->
                        <div id="search--box" class="xl:w-[680px] sm:w-96  rounded-xl overflow-hidden z-20 bg-secondery max-md:hidden w-screen left-0 max-sm:fixed max-sm:top-2 dark:!bg-white/5">
        ...
        <!-- sidebar -->
        <div id="site__sidebar" class="box fixed top-0 left-0 z-[99] pt-[--m-top] overflow-hidden transition-transform xl:duration-500 max-xl:w-full max-xl:-translate-x-full">
        ...
        <main id="site__main" class="2xl:ml-[--w-side]  xl:ml-[--w-side-sm] p-5 h-[calc(100vh-var(--m-top))] mt-[--m-top]">
            ...
            <div class="lg:flex 2xl:gap-16 gap-12 max-w-[1065px] mx-auto"  id="js-oversized">
                ...
                <div class="flex-1"> 
                    ...
                    <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6 sm:mt-2" 
