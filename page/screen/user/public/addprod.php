                            ...
                            <div class="p-4 space-y-2">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="flex justify-between w-full">
                                        <input type="number" class="w-1/2 mr-2 mb-3" placeholder="Quantité minimum" name="Quantité-min">
                                        <input type="number" class="w-1/2 mb-3" placeholder="Quantité maximum" name="Quantité-max">
                                    </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="flex justify-between p-3 items-center">
                                        ...
                                        <div class="p-4 border-dotted border-2 border-gray-400 rounded-md relative">
                                            ...
                                            <input id="file-upload2" class="hidden" type="file" onchange="previewImage2(this)" name="image">
                                            <img id="image-preview2" class="absolute inset-0 w-full h-full object-cover hidden">
                                            <button onclick="removeImage2()" id="remove-button2" class="absolute top-2 right-3 text-red-500 text-xl font-bold rounded-full bg-white p-1 hidden">&times;</button>
                                        </div>
                                    </div>
                                    <textarea class="w-full h-20" name="descrip" id="" cols="30" rows="10" placeholder="Description"></textarea>

                                    <div class="flex items-center gap-4 mt-4 lg:pl-[10.5rem]">
                                        <button type="reset" class="button lg:px-6 bg-secondery max-md:flex-1">
                                            Annuler</button>
                                        <button type="submit" name="submit2" class="button lg:px-10 bg-primary text-white max-md:flex-1"> Ajouter <span class="ripple-overlay"></span></button>
                                    </div>
                                </form>
