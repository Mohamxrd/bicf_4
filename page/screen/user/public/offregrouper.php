...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $recupprods->bindParam(':id', $id_prod, PDO::PARAM_INT);
    $recupprods->execute();
...
if (isset($_GET['id'], $_SESSION['id_user'], $_POST['ajout_quantite'])) {
    ...
    if (filter_var($ajout_quantite, FILTER_VALIDATE_INT) && $ajout_quantite > 0) {
        ...
        $insertQuery = $conn->prepare("INSERT INTO offregroup (qte_prod, id_demander, id_prod) VALUES (:qte_prod, :id_demander, :id_prod)");
...
if (isset($_GET['id'])) {
    ...
    $sumQuery = $conn->prepare("SELECT SUM(qte_prod) AS total_quantite FROM offregroup WHERE id_prod = :id_prod");
    $sumQuery->bindParam(':id_prod', $id_prod, PDO::PARAM_INT);
    $sumQuery->execute();
                ...
                <div class="flex-1 items-center justify-center">
                    ...
                    <div class="flex items-center flex-col lg:space-y-4 lg:pb-8 max-lg:w-full  sm:grid-cols-2 max-lg:gap-6 sm:mt-2" uk-sticky="media: 1024; end: #js-oversized; offset: 80">
                        ...
                        <div class="w-full box flex justify-between mb-3 p-5">
                            ...
                            <h4 class="card-title">Nombre de fournisseurs</h4>
                            <p> <?= $totalPers ?></p>
                    ...
                    <div id="countdown-container" class="flex flex-col justify-center items-center mt-8">
